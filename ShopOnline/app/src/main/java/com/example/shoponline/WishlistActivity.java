...
public class WishlistActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void getItems(){
        ...
        ViewWishlist wish_list=new ViewWishlist(user_id);
        ...
        Call<List<CreateWishlist>> call=JsonHolder.View_Wishlist(wish_list);

        call.enqueue(new Callback<List<CreateWishlist>>() {
            @Override
            public void onResponse(Call<List<CreateWishlist>> call, Response<List<CreateWishlist>> response) {
                ...
                List<CreateWishlist> wish_list= response.body();
                for(CreateWishlist c: wish_list){
                    wish_product_id.add(c.getProduct_id());}
            }

            @Override
            public void onFailure(Call<List<CreateWishlist>> call, Throwable t) {
